	...
	<script type="text/javascript">
		...
		function deleteconfirm(id)
		{
			var answer = confirm("確定要刪除嗎?");
					if (answer){
						window.location.href = './access_delete.php?id='+id;
					}
					else{
						return false;
					}
							  ...
							  <div class="modal-dialog" role="document">
								<div class="modal-content">
								  ...
								  <div class="modal-body">
									<form id="contentForm" method="post" action="./access_insert.php">
									  ...
									  <div class="form-group">
										...
										<input type="text" class="form-control" id="room" name="room" placeholder="E-00-00-A" required>
									  </div>
									  <div class="form-group">
										<label for="time_leave" class="col-form-label">離開時間：</label>
										<input type="text" class="form-control" id="time_leave" name="time_leave" required>
											<script src="/laydate/laydate.js"></script>
											<script>
												//時間選擇器
												laydate.render({
									  ...
									  <div class="form-group">
										<label for="time_enter" class="col-form-label">進入時間：</label>
										<input type="text" class="form-control" id="time_enter" name="time_enter" required>
											<script src="/laydate/laydate.js"></script>
											<script>
												//時間選擇器
												laydate.render({
